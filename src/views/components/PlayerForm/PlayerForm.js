...
export class PlayerForm extends ComponentView {
    ...
    handleInputField() {
        ...
        this.inputField.classList = 'input input-field-active';
        ...
        this.inputField.addEventListener('input', () => {
            if (this.inputField.value !== '') {
                ...
                this.inputField.classList = 'input';
            }
            this.checkValidationButtonState();
        });
    }
    ...
    preselectHero() {
        ...
        const preselectedHero = heroes[0];

        this.selectHero(preselectedHero);
        this.emit(`setAvatarButtonState-Active-${preselectedHero.id}`);
    }
